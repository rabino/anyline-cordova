 ...
 * @since 3.3.1
 */
- (void)anylineDocumentModuleView:(AnylineDocumentModuleView *)anylineEnergyModuleView
 ...
 * @since 3.3.1
 */
- (BOOL)anylineDocumentModuleView:(AnylineDocumentModuleView *)anylineEnergyModuleView
 ...
 * @since 3.3.1
 */
- (void)anylineDocumentModuleViewTakePictureSuccess:(AnylineDocumentModuleView *)anylineEnergyModuleView;
 ...
 * @since 3.3.1
 */
- (void)anylineDocumentModuleView:(AnylineDocumentModuleView *)anylineEnergyModuleView takePictureError:(NSError *)error;
